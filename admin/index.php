...
try {
    if (($_SERVER['REQUEST_METHOD'] ?? '') === 'POST') {
        ...
        $statement = adminDb()->prepare('UPDATE orders SET order_status = :order_status, payment_status = :payment_status, delivery_status = :delivery_status WHERE id = :id');
